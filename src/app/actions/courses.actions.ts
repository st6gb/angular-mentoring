...
export const selectCourses = (state: State) => state.allCourses;
export const selectPageCourse = (state: State) => state.allCourses.page;
export const selectAmountCourse = (state: State) => state.allCourses.amount;
export const selectCanLoadedCourse = (state: State) => state.allCourses.canLoaded;
